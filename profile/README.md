...
- [chore(wavebox): update to 149.2.96-2](https://github.com/wimpysworld/nix-config/pull/887) on [wimpysworld/nix-config](https://github.com/wimpysworld/nix-config) (today)
...
- [sinelaw/fresh](https://github.com/sinelaw/fresh) ([v0.4.1](https://github.com/sinelaw/fresh/releases/tag/v0.4.1), today)
...
- [JuliusBrussee/caveman](https://github.com/JuliusBrussee/caveman) (74512)
  - 🪨 why use many token when few token do trick — Claude Code skill that cuts 65% of tokens by talking like caveman
- [danny-avila/LibreChat](https://github.com/danny-avila/LibreChat) (39419)
