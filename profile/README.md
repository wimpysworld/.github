...
- [wimpysworld/nix-config](https://github.com/wimpysworld/nix-config) ([v25.5.20250712](https://github.com/wimpysworld/nix-config/releases/tag/v25.5.20250712), today)
  - Wimpy&#39;s NixOS, nix-darwin  &amp; Home Manager Configurations ❄️
...
- [nix-community/nh](https://github.com/nix-community/nh) (1717)
  - Yet another Nix CLI helper. [Maintainers=@viperML, @NotAShelf]
- [wimpysworld/faff](https://github.com/wimpysworld/faff) (31)
  - Drop the faff, dodge the judgment. Another bloody AI commit generator, but this one stays local 🦙
- [openai/whisper](https://github.com/openai/whisper) (84856)
