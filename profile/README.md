...
- [chore(openchamber-desktop): update to 1.9.1](https://github.com/wimpysworld/nix-config/pull/723) on [wimpysworld/nix-config](https://github.com/wimpysworld/nix-config) (today)
- [feat(tray): add zoom level submenu with 5 preset options](https://github.com/wimpysworld/sidra/pull/36) on [wimpysworld/sidra](https://github.com/wimpysworld/sidra) (today)
...
- [mksglu/context-mode](https://github.com/mksglu/context-mode) (5816)
