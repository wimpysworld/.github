...
- [feat: add organization-wide label sync workflow and documentation](https://github.com/Oval-Tutu/.github/pull/3) on [Oval-Tutu/.github](https://github.com/Oval-Tutu/.github) (2 days ago)
- [feat: modernize issue templates with YAML forms and contact links](https://github.com/Oval-Tutu/.github/pull/2) on [Oval-Tutu/.github](https://github.com/Oval-Tutu/.github) (2 days ago)
- [refactor(dockerfile): switch from custom ffmpeg to jellyfin-ffmpeg](https://github.com/wimpysworld/stream-sprout/pull/66) on [wimpysworld/stream-sprout](https://github.com/wimpysworld/stream-sprout) (3 days ago)
...
- [DeterminateSystems/determinate-nix-action](https://github.com/DeterminateSystems/determinate-nix-action) ([v3.9.1](https://github.com/DeterminateSystems/determinate-nix-action/releases/tag/v3.9.1), 1 day ago)
  - The Github Action for Determinate Nix
- [wimpysworld/nix-config](https://github.com/wimpysworld/nix-config) ([v25.5.20250826](https://github.com/wimpysworld/nix-config/releases/tag/v25.5.20250826), 2 days ago)
  - Wimpy&#39;s NixOS, nix-darwin  &amp; Home Manager Configurations ❄️
- [wimpysworld/stream-sprout](https://github.com/wimpysworld/stream-sprout) ([0.1.6](https://github.com/wimpysworld/stream-sprout/releases/tag/0.1.6), 3 days ago)
  - Restream a video source to multiple destinations such as Twitch, YouTube, Owncast and Peertube 📡
...
- [ref-tools/ref-tools-mcp](https://github.com/ref-tools/ref-tools-mcp) (492)
...
- [firecrawl/firecrawl](https://github.com/firecrawl/firecrawl) (53209)
