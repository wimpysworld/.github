...
- [refactor: oxidise NixOS](https://github.com/wimpysworld/nix-config/pull/503) on [wimpysworld/nix-config](https://github.com/wimpysworld/nix-config) (2 days ago)
- [ui: replace emoji with coloured unicode symbols/glyphs](https://github.com/wimpysworld/ia-get/pull/38) on [wimpysworld/ia-get](https://github.com/wimpysworld/ia-get) (3 days ago)
- [refactor: improve URL validation and error messages](https://github.com/wimpysworld/ia-get/pull/37) on [wimpysworld/ia-get](https://github.com/wimpysworld/ia-get) (3 days ago)
- [ui: enhance download progress information with a counter](https://github.com/wimpysworld/ia-get/pull/36) on [wimpysworld/ia-get](https://github.com/wimpysworld/ia-get) (3 days ago)
- [refactor: improves error handling and URL validation](https://github.com/wimpysworld/ia-get/pull/35) on [wimpysworld/ia-get](https://github.com/wimpysworld/ia-get) (3 days ago)

### Recent releases 📦️


- [wimpysworld/nix-config](https://github.com/wimpysworld/nix-config) ([v25.5.20250525](https://github.com/wimpysworld/nix-config/releases/tag/v25.5.20250525), 2 days ago)
  - Wimpy&#39;s NixOS, nix-darwin  &amp; Home Manager Configurations ❄️
- [wimpysworld/ia-get](https://github.com/wimpysworld/ia-get) ([0.1.2](https://github.com/wimpysworld/ia-get/releases/tag/0.1.2), 3 days ago)
  - File downloader for archive.org ⬇️
- [DeterminateSystems/determinate-nix-action](https://github.com/DeterminateSystems/determinate-nix-action) ([v3.6.1](https://github.com/DeterminateSystems/determinate-nix-action/releases/tag/v3.6.1), 4 days ago)
  - The Github Action for Determinate Nix
- [DeterminateSystems/nix-installer](https://github.com/DeterminateSystems/nix-installer) ([v3.6.1](https://github.com/DeterminateSystems/nix-installer/releases/tag/v3.6.1), 4 days ago)
...
- [openai/whisper](https://github.com/openai/whisper) (82396)
...
- [DeterminateSystems/determinate-nix-action](https://github.com/DeterminateSystems/determinate-nix-action) (2)
  - The Github Action for Determinate Nix
- [wimpysworld/nothing-but-nix](https://github.com/wimpysworld/nothing-but-nix) (71)
  - Create a 130GB Nix ️store in GitHub runners ❄️ Multi-partition BTRFS RAID-0 for /nix 💪 Brutally purges unnecessary software 🪓 Dynamically grows the Nix store 📈
...
- [Python A-Go-Go](https://linuxmatters.sh/56/) (1 day ago)
