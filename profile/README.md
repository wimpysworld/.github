...
- [feat(filesync): add Syncthing mixins and key-generation script](https://github.com/wimpysworld/nix-config/pull/616) on [wimpysworld/nix-config](https://github.com/wimpysworld/nix-config) (today)
...
- [folke/snacks.nvim](https://github.com/folke/snacks.nvim) (6994)
  - 🍿 A collection of QoL plugins for Neovim
- [linuxmatters/jivetalking](https://github.com/linuxmatters/jivetalking) (42)
  - Raw microphone recordings into broadcast-ready audio in one command. No configuration, and no surprises🕺
- [wailsapp/wails](https://github.com/wailsapp/wails) (32575)
  - Create beautiful applications using Go
- [sinelaw/fresh](https://github.com/sinelaw/fresh) (5681)
